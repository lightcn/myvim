...
set fileencodings=utf-8,gb2312,gb18030,ucs-bom,gbk,cp936,latin-1     "设置支持打开的文件的编码
...
" -----------------------------------------------------------------------------
" 用于自动生成tags
" 关闭easytags的自动语法高亮，其他的插件已经提供了较好的高亮，不需要。
let b:easytags_auto_highlight=0
" 如果你想打开自动语法高亮，在对应的文件中输入
" :autocmd FileType python let b:easytags_auto_highlight=0 
" 设置easytags 更新tags为异步模式
let g:easytags_async=1
" 仅限于保存的时候才生成tags
let g:easytags_events=['BufWritePost']
" 生成tags的层次，也即需要你在项目根目录下先
" ctags ./一个tags文件，然后就可以自由使用了。
